    ...
    <div className="py-8 px-4 max-w-7xl mx-auto">
      ...
      {updateStatus && (
        <div className={`mb-4 p-3 rounded-md ${
          updateStatus.type === 'success' ? 'bg-green-100 text-green-700 border-l-4 border-green-500' :
          updateStatus.type === 'error' ? 'bg-red-100 text-red-700 border-l-4 border-red-500' :
